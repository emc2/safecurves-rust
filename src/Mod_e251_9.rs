...
#[derive(Copy, Clone)]
pub struct Mod_e251_9(pub [u32; 9]);

impl PrimeField for Mod_e251_9 {
    fn zero() -> Mod_e251_9 {
        Mod_e251_9([ 0, 0, 0, 0, 0, 0, 0, 0, 0 ])
    }

    fn one() -> Mod_e251_9 {
        Mod_e251_9([ 1, 0, 0, 0, 0, 0, 0, 0, 0 ])
    }

    fn modulus() -> Mod_e251_9 {
        Mod_e251_9([ 0x0ffffff7, 0x0fffffff, 0x0fffffff, 0x0fffffff,
...
impl Mod_e251_9 {
    fn pack(&self) -> [u8; 32] {
        ...
        bytes[31] = ((self[8] >> 24) & 0b00001111) as u8;

        bytes;
    }

    fn unpack(bytes : &[u8; 28]) -> Mod_e251_9 {
        let mut out = Mod_e251_9([0u32; 9]);
