...
/// Bitmasks corresponding to Mod_e222_117.
#[derive(Copy, Clone)]
pub struct Mod_e222_117_Mask([i64; 4]);
...
pub const ONE: Mod_e222_117 = Mod_e222_117([ 1, 0, 0, 0 ]);

/// The normalized representation of the value -1.
pub const M_ONE: Mod_e222_117 =
    Mod_e222_117([ 0x03ffffffffffff8a, 0x03ffffffffffffff,
                   0x03ffffffffffffff, 0x0000ffffffffffff ]);

/// The normalized representation of the modulus 2^222 - 117.
pub const MODULUS: Mod_e222_117 =
    Mod_e222_117([ 0x03ffffffffffff8b, 0x03ffffffffffffff,
                   0x03ffffffffffffff, 0x0000ffffffffffff ]);

/// The d value 160102 in the Edwards curve equation x^2 + y^2 = 1 +
/// dx^2 y^2 for E-222.
pub const E222_D: Mod_e222_117 = Mod_e222_117([ 0x27166, 0, 0, 0 ]);

/// The x-coordinate of the base point of the curve E-222,
...
/// The y-coordinate of the base point of the curve E-222, 0x1c.
pub const E222_BASE_Y: Mod_e222_117 = Mod_e222_117([ 0x1c, 0, 0, 0 ]);

/// The prime subgroup order of the curve M-221,
...
impl Debug for Mod_e222_117 {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        try!(write!(f, "Mod_e222_117: [ {:x}", &self.0[0]));
...
impl LowerHex for Mod_e222_117 {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
...
impl UpperHex for Mod_e222_117 {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        let mut cpy = self.clone();
        let bytes = cpy.packed();
...
impl Neg for Mod_e222_117 {
    type Output = Mod_e222_117;

    fn neg(self) -> Mod_e222_117 {
        let mut out = self;
...
impl<'b> AddAssign<&'b Mod_e222_117> for Mod_e222_117 {
    fn add_assign(&mut self, rhs: &'b Mod_e222_117) {
        let a0 = self.0[0];
        let a1 = self.0[1];
        let a2 = self.0[2];
        let a3 = self.0[3] & 0x0000ffffffffffff;

        let b0 = rhs.0[0];
        let b1 = rhs.0[1];
        let b2 = rhs.0[2];
        let b3 = rhs.0[3] & 0x0000ffffffffffff;
        ...
        self.0[0] = s0 & 0x03ffffffffffffff;
        self.0[1] = s1 & 0x03ffffffffffffff;
        self.0[2] = s2 & 0x03ffffffffffffff;
        self.0[3] = s3;
    }
}

impl AddAssign<Mod_e222_117> for Mod_e222_117 {
    fn add_assign(&mut self, rhs: Mod_e222_117) {
        *self += &rhs;
    }
}

impl AddAssign<i32> for Mod_e222_117 {
    fn add_assign(&mut self, rhs: i32) {
        self.small_add_assign(rhs);
    }
}

impl AddAssign<i16> for Mod_e222_117 {
    fn add_assign(&mut self, rhs: i16) {
        self.small_add_assign(rhs as i32);
    }
}

impl AddAssign<i8> for Mod_e222_117 {
    fn add_assign(&mut self, rhs: i8) {
        self.small_add_assign(rhs as i32);
    }
}

impl<'a, 'b> Add<&'b Mod_e222_117> for &'a Mod_e222_117 {
    type Output = Mod_e222_117;

    fn add(self, a: &'b Mod_e222_117) -> Mod_e222_117 {
...
impl Add<Mod_e222_117> for Mod_e222_117 {
    type Output = Mod_e222_117;

    fn add(self, a: Mod_e222_117) -> Mod_e222_117 {
        &self + &a
    }
}

impl<'a> Add<&'a Mod_e222_117> for i32 {
    type Output = Mod_e222_117;

    fn add(self, a: &'a Mod_e222_117) -> Mod_e222_117 {
        a.small_add(self)
    }
}

impl<'a> Add<&'a Mod_e222_117> for i16 {
    type Output = Mod_e222_117;
...
impl<'a> Add<&'a Mod_e222_117> for i8 {
    type Output = Mod_e222_117;
...
impl<'a> Add<i32> for &'a Mod_e222_117 {
    type Output = Mod_e222_117;

    fn add(self, a: i32) -> Mod_e222_117 {
        self.small_add(a)
    }
}

impl<'a> Add<i16> for &'a Mod_e222_117 {
    type Output = Mod_e222_117;

    fn add(self, a: i16) -> Mod_e222_117 {
        self.small_add(a as i32)
    }
}

impl<'a> Add<i8> for &'a Mod_e222_117 {
    type Output = Mod_e222_117;

    fn add(self, a: i8) -> Mod_e222_117 {
        self.small_add(a as i32)
    }
}

impl Add<i32> for Mod_e222_117 {
    type Output = Mod_e222_117;
...
impl<'b> DivAssign<&'b Mod_e222_117> for Mod_e222_117 {
    fn div_assign(&mut self, rhs: &'b Mod_e222_117) {
        *self *= &rhs.inverted();
    }
}

impl DivAssign<Mod_e222_117> for Mod_e222_117 {
    fn div_assign(&mut self, rhs: Mod_e222_117) {
        *self /= &rhs;
    }
}

impl<'a, 'b> Div<&'b Mod_e222_117> for &'a Mod_e222_117 {
    type Output = Mod_e222_117;

    fn div(self, a: &'b Mod_e222_117) -> Mod_e222_117 {
        let mut out = self.clone();
        out /= a;
        out
    }
...
impl Div<Mod_e222_117> for Mod_e222_117 {
    type Output = Mod_e222_117;

    fn div(self, a: Mod_e222_117) -> Mod_e222_117 {
        &self / &a
    }
}

impl<'b> SubAssign<&'b Mod_e222_117> for Mod_e222_117 {
    fn sub_assign(&mut self, rhs: &'b Mod_e222_117) {
        let a0 = self.0[0];
        let a1 = self.0[1];
        let a2 = self.0[2];
        let a3 = self.0[3] & 0x0000ffffffffffff;
...
impl SubAssign<Mod_e222_117> for Mod_e222_117 {
    fn sub_assign(&mut self, rhs: Mod_e222_117) {
        *self -= &rhs
    }
}

impl SubAssign<i32> for Mod_e222_117 {
    fn sub_assign(&mut self, rhs: i32) {
        self.small_sub_assign(rhs);
    }
}

impl SubAssign<i16> for Mod_e222_117 {
    fn sub_assign(&mut self, rhs: i16) {
        self.small_sub_assign(rhs as i32);
    }
}

impl SubAssign<i8> for Mod_e222_117 {
    fn sub_assign(&mut self, rhs: i8) {
        self.small_sub_assign(rhs as i32);
    }
}

impl Sub<i32> for Mod_e222_117 {
    type Output = Mod_e222_117;

    fn sub(self, a: i32) -> Mod_e222_117 {
        &self - a
    }
}

impl Sub<i16> for Mod_e222_117 {
    type Output = Mod_e222_117;

    fn sub(self, a: i16) -> Mod_e222_117 {
        &self - a
    }
}

impl Sub<i8> for Mod_e222_117 {
    type Output = Mod_e222_117;

    fn sub(self, a: i8) -> Mod_e222_117 {
        &self - a
    }
}

impl<'a, 'b> Sub<&'b Mod_e222_117> for &'a Mod_e222_117 {
    type Output = Mod_e222_117;

    fn sub(self, a: &'b Mod_e222_117) -> Mod_e222_117 {
        let mut out = self.clone();
        out -= a;
        out
    }
...
impl Sub<Mod_e222_117> for Mod_e222_117 {
    type Output = Mod_e222_117;

    fn sub(self, a: Mod_e222_117) -> Mod_e222_117 {
        &self - &a
    }
}

impl<'a> Sub<i32> for &'a Mod_e222_117 {
    type Output = Mod_e222_117;
...
impl<'a> Sub<i16> for &'a Mod_e222_117 {
    type Output = Mod_e222_117;
...
impl<'a> Sub<i8> for &'a Mod_e222_117 {
    type Output = Mod_e222_117;
...
impl MulAssign<i32> for Mod_e222_117 {
    fn mul_assign(&mut self, rhs: i32) {
        self.small_mul_assign(rhs);
    }
}

impl MulAssign<i16> for Mod_e222_117 {
    fn mul_assign(&mut self, rhs: i16) {
        self.small_mul_assign(rhs as i32);
    }
}

impl MulAssign<i8> for Mod_e222_117 {
    fn mul_assign(&mut self, rhs: i8) {
        self.small_mul_assign(rhs as i32);
    }
}

impl<'b> MulAssign<&'b Mod_e222_117> for Mod_e222_117 {
    fn mul_assign(&mut self, rhs: &'b Mod_e222_117) {
        let a0 = self.0[0] & 0x1fffffff;
        let a1 = self.0[0] >> 29;
        let a2 = self.0[1] & 0x1fffffff;
        let a3 = self.0[1] >> 29;
        let a4 = self.0[2] & 0x1fffffff;
        let a5 = self.0[2] >> 29;
        let a6 = self.0[3] & 0x1fffffff;
        let a7 = self.0[3] >> 29;

        let b0 = rhs.0[0] & 0x1fffffff;
        let b1 = rhs.0[0] >> 29;
        let b2 = rhs.0[1] & 0x1fffffff;
        let b3 = rhs.0[1] >> 29;
        let b4 = rhs.0[2] & 0x1fffffff;
        let b5 = rhs.0[2] >> 29;
        let b6 = rhs.0[3] & 0x1fffffff;
        let b7 = rhs.0[3] >> 29;
        ...
        let l3_0 = d3 & 0x0000ffffffffffff;

        // Shift the high bits down into another n-bit number.
        let h0_0 = ((d3 & 0x03ffffffffffffff) >> 48) |
                   ((d4 & 0x000000000007ffff) << 10);
        let h1_0 = (d4 & 0x0000fffffff80000) >> 19;
        let h2_0 = ((d4 & 0x03ff000000000000) >> 48) |
                   ((d5 & 0x000000000007ffff) << 10);
        let h3_0 = (d5 & 0x0000fffffff80000) >> 19;
        let h4_0 = ((d5 & 0x03ff000000000000) >> 48) |
                   ((d6 & 0x000000000007ffff) << 10);
        let h5_0 = (d6 & 0x0000fffffff80000) >> 19;
        let h6_0 = ((d6 & 0x03ff000000000000) >> 48) |
                   ((d7 & 0x000000000007ffff) << 10);
        let h7_0 = d7 >> 19;
        ...
        let hm0_0 = hc0_0 + ((hc1_0 & 0x1fffffff) << 29);
        let hmk0_0 = hm0_0 >> 58;
        let hm1_0 = (hc1_0 >> 29) + hc2_0 +
                    ((hc3_0 & 0x1fffffff) << 29) + hmk0_0;
        let hmk1_0 = hm1_0 >> 58;
        let hm2_0 = (hc3_0 >> 29) + hc4_0 +
                    ((hc5_0 & 0x1fffffff) << 29) + hmk1_0;
        let hmk2_0 = hm2_0 >> 58;
        let hm3_0 = (hc5_0 >> 29) + hc6_0 +
                    ((hc7_0 & 0x1fffffff) << 29) + hmk2_0;

        // Add h and l.
        let kin_0 = hm3_0 >> 48;
        let s0_0 = l0_0 + (hm0_0 & 0x03ffffffffffffff) + (kin_0 * C_VAL);
        let k0_0 = s0_0 >> 58;
        let s1_0 = l1_0 + (hm1_0 & 0x03ffffffffffffff) + k0_0;
        let k1_0 = s1_0 >> 58;
        let s2_0 = l2_0 + (hm2_0 & 0x03ffffffffffffff) + k1_0;
        let k2_0 = s2_0 >> 58;
        let s3_0 = l3_0 + (hm3_0 & 0x0000ffffffffffff) + k2_0;

        self.0[0] = s0_0 & 0x03ffffffffffffff;
        self.0[1] = s1_0 & 0x03ffffffffffffff;
        self.0[2] = s2_0 & 0x03ffffffffffffff;
        self.0[3] = s3_0;
    }
}

impl MulAssign<Mod_e222_117> for Mod_e222_117 {
    fn mul_assign(&mut self, rhs: Mod_e222_117) {
        *self *= &rhs;
    }
}

impl<'a> Mul<&'a Mod_e222_117> for i32 {
    type Output = Mod_e222_117;

    fn mul(self, a: &'a Mod_e222_117) -> Mod_e222_117 {
        a.small_mul(self)
    }
}

impl<'a> Mul<&'a Mod_e222_117> for i16 {
    type Output = Mod_e222_117;
...
impl<'a> Mul<&'a Mod_e222_117> for i8 {
    type Output = Mod_e222_117;
...
impl<'a> Mul<i32> for &'a Mod_e222_117 {
    type Output = Mod_e222_117;

    fn mul(self, a: i32) -> Mod_e222_117 {
        self.small_mul(a)
    }
}

impl<'a> Mul<i16> for &'a Mod_e222_117 {
    type Output = Mod_e222_117;

    fn mul(self, a: i16) -> Mod_e222_117 {
        self.small_mul(a as i32)
    }
}

impl<'a> Mul<i8> for &'a Mod_e222_117 {
    type Output = Mod_e222_117;

    fn mul(self, a: i8) -> Mod_e222_117 {
        self.small_mul(a as i32)
    }
}

impl Mul<i32> for Mod_e222_117 {
    type Output = Mod_e222_117;
...
impl<'a, 'b> Mul<&'b Mod_e222_117> for &'a Mod_e222_117 {
    type Output = Mod_e222_117;

    fn mul(self, a: &'b Mod_e222_117) -> Mod_e222_117 {
        let mut out = self.clone();
        out *= a;
        out
    }
...
impl Mul<Mod_e222_117> for Mod_e222_117 {
    type Output = Mod_e222_117;

    fn mul(self, a: Mod_e222_117) -> Mod_e222_117 {
        &self * &a
    }
}

impl Rand for Mod_e222_117 {
...
impl Pack for Mod_e222_117 {
    fn unpack(&mut self, bytes: &[u8]) {
        ...
        self.0[1] = (((bytes[7] as i64) >> 2) & 0x000000000000003f) |
        ...
        self.0[2] = (((bytes[14] as i64) >> 4) & 0x000000000000000f) |
        ...
        self.0[3] = (((bytes[21] as i64) >> 6) & 0x0000000000000003) |
                  ...
                  (((bytes[27] as i64) << 42) & 0x0000fc0000000000);
    }
    ...
    fn pack_normalized(&self, bytes: &mut [u8]) {
        ...
        bytes[7] = (((self.0[0] >> 56) & 0b00000011) as u8) |
                   (((self.0[1] << 2) & 0b11111100) as u8);
        bytes[8] = ((self.0[1] >> 6) & 0b11111111) as u8;
        bytes[9] = ((self.0[1] >> 14) & 0b11111111) as u8;
        bytes[10] = ((self.0[1] >> 22) & 0b11111111) as u8;
        bytes[11] = ((self.0[1] >> 30) & 0b11111111) as u8;
        bytes[12] = ((self.0[1] >> 38) & 0b11111111) as u8;
        bytes[13] = ((self.0[1] >> 46) & 0b11111111) as u8;
        bytes[14] = (((self.0[1] >> 54) & 0b00001111) as u8) |
                    (((self.0[2] << 4) & 0b11110000) as u8);
        bytes[15] = ((self.0[2] >> 4) & 0b11111111) as u8;
        bytes[16] = ((self.0[2] >> 12) & 0b11111111) as u8;
        bytes[17] = ((self.0[2] >> 20) & 0b11111111) as u8;
        bytes[18] = ((self.0[2] >> 28) & 0b11111111) as u8;
        bytes[19] = ((self.0[2] >> 36) & 0b11111111) as u8;
        bytes[20] = ((self.0[2] >> 44) & 0b11111111) as u8;
        bytes[21] = (((self.0[2] >> 52) & 0b00111111) as u8) |
                    (((self.0[3] << 6) & 0b11000000) as u8);
        bytes[22] = ((self.0[3] >> 2) & 0b11111111) as u8;
        bytes[23] = ((self.0[3] >> 10) & 0b11111111) as u8;
        bytes[24] = ((self.0[3] >> 18) & 0b11111111) as u8;
        bytes[25] = ((self.0[3] >> 26) & 0b11111111) as u8;
        bytes[26] = ((self.0[3] >> 34) & 0b11111111) as u8;
        bytes[27] = ((self.0[3] >> 42) & 0b00111111) as u8;
    }
...
impl Normalize for Mod_e222_117 {
...
impl NormalizeEq for Mod_e222_117 {
...
impl PrimeFieldMask for Mod_e222_117_Mask {
...
impl PrimeField for Mod_e222_117 {
    ...
    fn invert(&mut self) {
        ...
        *self *= &sqval;
        ...
        // Fifth, sixth, and seventh digit is 0.
        sqval.square();
        sqval.square();
        sqval.square();
    ...
    fn small_add(&self, rhs: i32) -> Mod_e222_117 {
        let mut out = self.clone();
    ...
    fn small_sub(&self, rhs: i32) -> Mod_e222_117 {
        let mut out = self.clone();
    ...
    fn small_mul_assign(&mut self, rhs: i32) {
        ...
        self.0[0] = d0 & 0x03ffffffffffffff;
        self.0[1] = d1 & 0x03ffffffffffffff;
        self.0[2] = d2 & 0x03ffffffffffffff;
        self.0[3] = d3;
    }

    fn small_mul(&self, b: i32) -> Mod_e222_117 {
        let mut out = self.clone();
...
mod tests {
    ...
    const TWO: Mod_e222_117 = Mod_e222_117([ 2, 0, 0, 0 ]);

    const M_TWO: Mod_e222_117 =
        Mod_e222_117([ 0x03ffffffffffff89, 0x03ffffffffffffff,
                       0x03ffffffffffffff, 0x0000ffffffffffff ]);

    const THREE: Mod_e222_117 = Mod_e222_117([ 3, 0, 0, 0 ]);

    const M_THREE: Mod_e222_117 =
        Mod_e222_117([ 0x03ffffffffffff88, 0x03ffffffffffffff,
                       0x03ffffffffffffff, 0x0000ffffffffffff ]);

    const FOUR: Mod_e222_117 = Mod_e222_117([ 4, 0, 0, 0 ]);

    const M_FOUR: Mod_e222_117 =
        Mod_e222_117([ 0x03ffffffffffff87, 0x03ffffffffffffff,
                       0x03ffffffffffffff, 0x0000ffffffffffff ]);

    const SIX: Mod_e222_117 = Mod_e222_117([ 6, 0, 0, 0 ]);

    const M_SIX: Mod_e222_117 =
        Mod_e222_117([ 0x03ffffffffffff85, 0x03ffffffffffffff,
                       0x03ffffffffffffff, 0x0000ffffffffffff ]);

    const EIGHT: Mod_e222_117 = Mod_e222_117([ 8, 0, 0, 0 ]);

    const M_EIGHT: Mod_e222_117 =
        Mod_e222_117([ 0x03ffffffffffff83, 0x03ffffffffffffff,
                       0x03ffffffffffffff, 0x0000ffffffffffff ]);

    const NINE: Mod_e222_117 = Mod_e222_117([ 9, 0, 0, 0 ]);

    const M_NINE: Mod_e222_117 =
        Mod_e222_117([ 0x03ffffffffffff82, 0x03ffffffffffffff,
                       0x03ffffffffffffff, 0x0000ffffffffffff ]);

    const SIXTEEN: Mod_e222_117 = Mod_e222_117([ 16, 0, 0, 0 ]);

    const M_SIXTEEN: Mod_e222_117 =
        Mod_e222_117([ 0x03ffffffffffff7b, 0x03ffffffffffffff,
                       0x03ffffffffffffff, 0x0000ffffffffffff ]);

    fn test_pack_unpack(expected: &[u8; 28]) {
        let mut unpacked = Mod_e222_117::unpacked(expected);
    ...
    fn test_unpack_pack(expected: &mut Mod_e222_117) {
        let bytes = expected.packed();
        let mut actual = Mod_e222_117::unpacked(&bytes);
    ...
    fn unpack_pack_test() {
        ...
        test_unpack_pack(&mut Mod_e222_117([ 0x03ffffffffffffff,
                                             0x0000000000000000,
                                             0x03ffffffffffffff,
                                             0x0000000000000000 ]));
        test_unpack_pack(&mut Mod_e222_117([ 0x0000000000000000,
                                             0x03ffffffffffffff,
                                             0x0000000000000000,
                                             0x0000ffffffffffff ]));
        test_unpack_pack(&mut Mod_e222_117([ 0x02aaaaaaaaaaaaaa,
                                             0x0155555555555555,
                                             0x02aaaaaaaaaaaaaa,
                                             0x0000555555555555 ]));
        test_unpack_pack(&mut Mod_e222_117([ 0x0155555555555555,
                                             0x02aaaaaaaaaaaaaa,
                                             0x0155555555555555,
                                             0x0000aaaaaaaaaaaa ]));
        test_unpack_pack(&mut Mod_e222_117([ 0x02aaaaaaaaaaaaaa,
    ...
    #[test]
    fn test_add() {
        let l1_zeros: [&mut Mod_e222_117; 5] = [ &mut (&ZERO + &ZERO),
                                                 &mut (&M_ONE + &ONE),
                                                 &mut (&ONE + &M_ONE),
                                                 &mut (&M_TWO + &TWO),
                                                 &mut (&TWO + &M_TWO) ];

        let l1_ones: [&mut Mod_e222_117; 4] = [ &mut (&ZERO + &ONE),
                                                &mut (&ONE + &ZERO),
                                                &mut (&M_ONE + &TWO),
                                                &mut (&TWO + &M_ONE) ];

        let l1_twos: [&mut Mod_e222_117; 3] = [ &mut (&ZERO + &TWO),
                                                &mut (&ONE + &ONE),
                                                &mut (&TWO + &ZERO) ];

        let l1_mones: [&mut Mod_e222_117; 4] = [ &mut (&ZERO + &M_ONE),
                                                 &mut (&M_ONE + &ZERO),
                                                 &mut (&M_TWO + &ONE),
                                                 &mut (&ONE + &M_TWO) ];

        let l1_mtwos: [&mut Mod_e222_117; 3] = [ &mut (&ZERO + &M_TWO),
                                                 &mut (&M_ONE + &M_ONE),
                                                 &mut (&M_TWO + &ZERO) ];
    ...
    #[test]
    fn test_sub() {
        let l1_zeros: [&mut Mod_e222_117; 3] = [ &mut (&ZERO - &ZERO),
                                                 &mut (&ONE - &ONE),
                                                 &mut (&TWO - &TWO) ];

        let l1_ones: [&mut Mod_e222_117; 4] = [ &mut (&ZERO - &M_ONE),
                                                &mut (&ONE - &ZERO),
                                                &mut (&M_ONE - &M_TWO),
                                                &mut (&TWO - &ONE) ];

        let l1_twos: [&mut Mod_e222_117; 3] = [ &mut (&ZERO - &M_TWO),
                                                &mut (&ONE - &M_ONE),
                                                &mut (&TWO - &ZERO) ];

        let l1_mones: [&mut Mod_e222_117; 4] = [ &mut (&ZERO - &ONE),
                                                 &mut (&M_ONE - &ZERO),
                                                 &mut (&M_TWO - &M_ONE),
                                                 &mut (&ONE - &TWO) ];

        let l1_mtwos: [&mut Mod_e222_117; 3] = [ &mut (&ZERO - &TWO),
                                                 &mut (&M_ONE - &ONE),
                                                 &mut (&M_TWO - &ZERO) ];
    ...
    #[test]
    fn test_mul() {
        let l1_zeros: [&mut Mod_e222_117; 9] = [ &mut (&ZERO * &ZERO),
                                                 &mut (&ONE * &ZERO),
                                                 &mut (&TWO * &ZERO),
                                                 &mut (&M_ONE * &ZERO),
                                                 &mut (&M_TWO * &ZERO),
        ...
        let l1_ones: [&mut Mod_e222_117; 2] = [ &mut (&ONE * &ONE),
                                                &mut (&M_ONE * &M_ONE) ];

        let l1_twos: [&mut Mod_e222_117; 4] = [ &mut (&ONE * &TWO),
                                                &mut (&TWO * &ONE),
                                                &mut (&M_ONE * &M_TWO),
                                                &mut (&M_TWO * &M_ONE) ];

        let l1_fours: [&mut Mod_e222_117; 2] = [ &mut (&TWO * &TWO),
                                                 &mut (&M_TWO * &M_TWO) ];

        let l1_mones: [&mut Mod_e222_117; 2] = [ &mut (&ONE * &M_ONE),
                                                 &mut (&M_ONE * &ONE) ];

        let l1_mtwos: [&mut Mod_e222_117; 4] = [ &mut (&ONE * &M_TWO),
                                                 &mut (&TWO * &M_ONE),
                                                 &mut (&M_ONE * &TWO),
                                                 &mut (&M_TWO * &ONE) ];

        let l1_mfours: [&mut Mod_e222_117; 2] = [ &mut (&TWO * &M_TWO),
                                                  &mut (&M_TWO * &TWO) ];
    ...
    fn test_square() {
        ...
        let l1_ones: [&mut Mod_e222_117; 4] = [ &mut (&ONE * &ONE),
                                                &mut (&M_ONE * &M_ONE),
                                                &mut ONE.squared(),
                                                &mut M_ONE.squared() ];
        ...
        let l1_threes: [&mut Mod_e222_117; 4] = [ &mut (&ONE * &THREE),
                                                  &mut (&THREE * &ONE),
                                                  &mut (&M_ONE * &M_THREE),
                                                  &mut (&M_THREE * &M_ONE) ];

        let l1_fours: [&mut Mod_e222_117; 4] = [ &mut (&TWO * &TWO),
                                                 &mut (&M_TWO * &M_TWO),
                                                 &mut TWO.squared(),
                                                 &mut M_TWO.squared() ];
    ...
    fn test_inv() {
        ...
        let l1_mthrees: [&mut Mod_e222_117; 4] = [ &mut (&ONE * &M_THREE),
                                                   &mut (&THREE * &M_ONE),
                                                   &mut (&M_ONE * &THREE),
                                                   &mut (&M_THREE * &ONE) ];
    ...
    fn test_sqrt() {
        ...
        for i in 0..10 {
            let val = l1_mtwos[i].sqrt();

            assert!(val.squared().normalize_eq(l1_mtwos[i]));
        }
    ...
    #[test]
    fn test_small_add() {
        let l1_zeros: [&mut Mod_e222_117; 5] = [ &mut ZERO.small_add(0),
                                                 &mut M_ONE.small_add(1),
                                                 &mut ONE.small_add(-1),
                                                 &mut M_TWO.small_add(2),
                                                 &mut TWO.small_add(-2) ];

        let l1_ones: [&mut Mod_e222_117; 5] = [ &mut ZERO.small_add(1),
                                                &mut M_ONE.small_add(2),
                                                &mut ONE.small_add(0),
                                                &mut M_TWO.small_add(3),
                                                &mut TWO.small_add(-1) ];

        let l1_twos: [&mut Mod_e222_117; 5] = [ &mut ZERO.small_add(2),
                                                &mut ONE.small_add(1),
                                                &mut M_ONE.small_add(3),
                                                &mut TWO.small_add(0),
                                                &mut M_TWO.small_add(4) ];

        let l1_mones: [&mut Mod_e222_117; 5] = [ &mut ZERO.small_add(-1),
                                                 &mut M_ONE.small_add(0),
                                                 &mut ONE.small_add(-2),
                                                 &mut M_TWO.small_add(1),
                                                 &mut TWO.small_add(-3) ];

        let l1_mtwos: [&mut Mod_e222_117; 5] = [ &mut ZERO.small_add(-2),
                                                 &mut M_ONE.small_add(-1),
                                                 &mut ONE.small_add(-3),
    ...
    #[test]
    fn test_small_sub() {
        let l1_zeros: [&mut Mod_e222_117; 5] = [ &mut ZERO.small_sub(0),
                                                 &mut M_ONE.small_sub(-1),
                                                 &mut ONE.small_sub(1),
                                                 &mut M_TWO.small_sub(-2),
                                                 &mut TWO.small_sub(2) ];

        let l1_ones: [&mut Mod_e222_117; 5] = [ &mut ZERO.small_sub(-1),
                                                &mut M_ONE.small_sub(-2),
                                                &mut ONE.small_sub(0),
                                                &mut M_TWO.small_sub(-3),
                                                &mut TWO.small_sub(1) ];

        let l1_twos: [&mut Mod_e222_117; 5] = [ &mut ZERO.small_sub(-2),
                                                &mut ONE.small_sub(-1),
                                                &mut M_ONE.small_sub(-3),
                                                &mut TWO.small_sub(0),
                                                &mut M_TWO.small_sub(-4) ];

        let l1_mones: [&mut Mod_e222_117; 5] = [ &mut ZERO.small_sub(1),
                                                 &mut M_ONE.small_sub(0),
                                                 &mut ONE.small_sub(2),
                                                 &mut M_TWO.small_sub(-1),
                                                 &mut TWO.small_sub(3) ];

        let l1_mtwos: [&mut Mod_e222_117; 5] = [ &mut ZERO.small_sub(2),
                                                 &mut M_ONE.small_sub(1),
                                                 &mut ONE.small_sub(3),
    ...
    fn test_small_mul() {
        ...
        let l1_zeros: [&mut Mod_e222_117; 9] = [ &mut ZERO.small_mul(0),
                                                 &mut ONE.small_mul(0),
                                                 &mut TWO.small_mul(0),
        ...
        let l1_ones: [&mut Mod_e222_117; 2] = [ &mut ONE.small_mul(1),
                                                &mut M_ONE.small_mul(-1) ];

        let l1_twos: [&mut Mod_e222_117; 4] = [ &mut ONE.small_mul(2),
                                                &mut TWO.small_mul(1),
                                                &mut M_ONE.small_mul(-2),
                                                &mut M_TWO.small_mul(-1) ];

        let l1_fours: [&mut Mod_e222_117; 2] = [ &mut TWO.small_mul(2),
                                                 &mut M_TWO.small_mul(-2) ];

        let l1_mones: [&mut Mod_e222_117; 2] = [ &mut ONE.small_mul(-1),
                                                 &mut M_ONE.small_mul(1) ];

        let l1_mtwos: [&mut Mod_e222_117; 4] = [ &mut ONE.small_mul(-2),
                                                 &mut TWO.small_mul(-1),
                                                 &mut M_ONE.small_mul(2),
                                                 &mut M_TWO.small_mul(1) ];

        let l1_mfours: [&mut Mod_e222_117; 2] = [ &mut TWO.small_mul(-2),
                                                  &mut M_TWO.small_mul(2) ];
