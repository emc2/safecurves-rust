...
/// Bitmasks corresponding to Mod_e414_17.
#[derive(Copy, Clone)]
pub struct Mod_e414_17_Mask([i64; 8]);
...
/// The d value 3617 in the Edwards curve equation x^2 + y^2 = 1 +
/// dx^2 y^2 for Curve41417.
pub const CURVE41417_D: Mod_e414_17 =
    Mod_e414_17([ 3617, 0, 0, 0, 0, 0, 0, 0 ]);


/// The x-coordinate of the base point of the curve Curve41417,
...
/// The y-coordinate of the base point of the curve Curve41417, 0x22.
pub const CURVE41417_BASE_Y: Mod_e414_17 =
    Mod_e414_17([ 0x22, 0, 0, 0, 0, 0, 0, 0 ]);

/// The prime subgroup order of the curve Curve41417,
...
impl Debug for Mod_e414_17 {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        try!(write!(f, "Mod_e414_17: [ {:x}", &self.0[0]));
...
impl<'b> AddAssign<&'b Mod_e414_17> for Mod_e414_17 {
    fn add_assign(&mut self, rhs: &'b Mod_e414_17) {
        ...
        let a5 = self.0[5];
        let a6 = self.0[6];
        let a7 = self.0[7] & 0x00000000003fffff;
        ...
        let b5 = rhs.0[5];
        let b6 = rhs.0[6];
        let b7 = rhs.0[7] & 0x00000000003fffff;
        ...
        self.0[6] = s6 & 0x00ffffffffffffff;
        self.0[7] = s7;
    }
}
...
impl<'b> MulAssign<&'b Mod_e414_17> for Mod_e414_17 {
    fn mul_assign(&mut self, rhs: &'b Mod_e414_17) {
        ...
        self.0[6] = s6_0 & 0x00ffffffffffffff;
        self.0[7] = s7_0;
     }
}
...
impl Pack for Mod_e414_17 {
    fn unpack(&mut self, bytes: &[u8]) {
        ...
        self.0[7] = ((bytes[49] as i64) & 0x00000000000000ff) |
    ...
    fn pack_normalized(&self, bytes: &mut [u8]) {
        ...
        bytes[48] = ((self.0[6] >> 48) & 0b11111111) as u8;
        bytes[49] = (self.0[7] & 0b11111111) as u8;
        bytes[50] = ((self.0[7] >> 8) & 0b11111111) as u8;
        bytes[51] = ((self.0[7] >> 16) & 0b00111111) as u8;
    }
...
impl Normalize for Mod_e414_17 {
...
impl NormalizeEq for Mod_e414_17 {
...
impl PrimeFieldMask for Mod_e414_17_Mask {
...
impl PrimeField for Mod_e414_17 {
    ...
    fn small_mul_assign(&mut self, rhs: i32) {
        ...
        self.0[6] = d6 & 0x00ffffffffffffff;
        self.0[7] = d7;
    }
...
mod tests {
    ...
    fn test_pack_unpack(expected: &[u8; 52]) {
        let mut unpacked = Mod_e414_17::unpacked(expected);
    ...
    fn test_unpack_pack(expected: &mut Mod_e414_17) {
        ...
        let mut actual = Mod_e414_17::unpacked(&bytes);
