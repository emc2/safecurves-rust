...
/// Bitmasks corresponding to Mod_e255_19.
#[derive(Copy, Clone)]
pub struct Mod_e255_19_Mask([i64; 5]);
...
/// The x-coordinate of the base point of the curve Curve25519, 0x9.
pub const CURVE25519_BASE_X: Mod_e255_19 = Mod_e255_19([ 0x9, 0, 0, 0, 0]);

/// The y-coordinate of the base point of the curve Curve25519,
...
/// The prime subgroup order of the curve Curve25519,
...
impl Debug for Mod_e255_19 {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        try!(write!(f, "Mod_e255_19: [ {:x}", &self.0[0]));
...
impl<'b> AddAssign<&'b Mod_e255_19> for Mod_e255_19 {
    fn add_assign(&mut self, rhs: &'b Mod_e255_19) {
        ...
        let a2 = self.0[2];
        let a3 = self.0[3];
        let a4 = self.0[4] & 0x000000007fffffff;

        let b0 = rhs.0[0];
        let b1 = rhs.0[1];
        let b2 = rhs.0[2];
        let b3 = rhs.0[3];
        let b4 = rhs.0[4] & 0x000000007fffffff;
...
impl Pack for Mod_e255_19 {
    ...
    fn pack_normalized(&self, bytes: &mut [u8]) {
        ...
        bytes[31] = ((self.0[4] >> 24) & 0b01111111) as u8;
    }
...
impl PrimeFieldMask for Mod_e255_19_Mask {
...
mod tests {
    ...
    fn test_unpack_pack(expected: &mut Mod_e255_19) {
        ...
        let mut actual = Mod_e255_19::unpacked(&bytes);
